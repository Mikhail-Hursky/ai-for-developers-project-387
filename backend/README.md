...
- **Расписание.** Слоты формируются на будни, 10:00–18:00 UTC, шаг равен
  ...
  Выходные присутствуют в ответе с пустым списком слотов. Контракт разрешает
  `durationMinutes` до 1440 (сутки), но рабочий день фиксирован в 8 часов —
  такой тип события не даёт ни одного слота ни в один день; это осознанное
  расхождение контракта с фиксированным рабочим днём, а не ошибка.
